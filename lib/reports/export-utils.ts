...
export async function exportToPDF(
    ...
    doc.text('EGOS Inteligência - Plataforma de Dados Públicos', 20, 15);
...
export async function exportToDOCX(
    ...
    children.push(
        new Paragraph({
            children: [
                new TextRun({
                    text: 'Documento gerado automaticamente pelo EGOS Inteligência - Plataforma de Dados Públicos',
                    italics: true,
                    size: 18,
                    color: '999999',
                }),
