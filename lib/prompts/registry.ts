...
export const PROMPT_REGISTRY: PromptConfig[] = [
    ...
    // ============================================
    {
        ...
        version: '5.1.0',
        category: 'chat',
        // Primary: MiniMax M2.5 (best cost/tool-call balance per EGOS orchestration matrix 2026-04-18)
        // Fallback: google/gemini-2.0-flash-001 (set via OPENROUTER_MODEL env override)
