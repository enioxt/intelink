#!/usr/bin/env python3
"""Validate public edition scope and language rules for Intelink."""
...
FORBIDDEN_PATH_GLOBS = (
    "api/src/egos_inteligencia/services/pattern_service.py",
    "api/src/egos_inteligencia/queries/pattern_*.cypher",
...
FORBIDDEN_IMPORT_TOKENS = (
    "from egos_inteligencia.services.pattern_service import",
)

PUBLIC_SURFACE_GLOBS = (
    "api/src/egos_inteligencia/routers/*.py",
