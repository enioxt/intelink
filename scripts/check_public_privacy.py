#!/usr/bin/env python3
"""Public-surface privacy gate checks for Intelink open release."""
...
def check_public_queries(repo_root: Path) -> list[str]:
    errors: list[str] = []
    # egos-inteligencia stores queries under api/src/egos_inteligencia/queries/
    query_dir = repo_root / "api" / "src" / "egos_inteligencia" / "queries"
