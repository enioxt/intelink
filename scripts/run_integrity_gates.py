#!/usr/bin/env python3
"""Run hard integrity gates against Neo4j and return pass/fail — Intelink edition.

Labels used in egos-inteligencia graph: Person, Company, Partner, Contract,
Sanction, PublicOffice, Investigation, Amendment, and many others defined in
infra/neo4j/init.cypher.
"""
# DEPENDENCY: pip install neo4j
